...
const VirtualRealtyNW = () => {
    return (
        <section className="case-study">
            <div className="one-column cover">
                <img src="/images/vrnw/home-mock.png" alt="Wireframes" />
                <div className="case-title">
                    <div className="top-text">Sophia Zhuk</div>
                    <h1>Virtual Realty NW</h1>
                </div>

                <p>
                A real estate photography website for showcasing services.
                </p>
            </div>
            ...
            <div className="one-column cover">
            <img src="/images/vrnw/home-mock2.png" alt="Wireframes" />
            </div>
...
export default VirtualRealtyNW;
